...
import com.yan.yang.progressview.app.UIUtils;
...
public class ProgressView extends View {
    ...
    private int uncheckedColor = Color.parseColor("#E6E6E6");
    ...
    public static final int TEXTPADDINGTOP = 5;
    public static final float NORMALTEXTSIZE = 14;
    ...
    private void initValues() {
        circleRadius = UIUtils.INSTANCE.dpToPx(CIRCLE_RADIUS);
        stokenRadius = UIUtils.INSTANCE.dpToPx(STOKEN_RADIUS);
        stokenWidth = UIUtils.INSTANCE.dpToPx(STOKEN_WIDTH);
        linePadding = UIUtils.INSTANCE.dpToPx(LINE_PADDING);
        textPaddingTop = UIUtils.INSTANCE.dpToPx(TEXTPADDINGTOP);
        normaltextSize = UIUtils.INSTANCE.spToPx(NORMALTEXTSIZE);
    }
    ...
    public void setData(List<Model> models, int themeColor) {
        this.checkedColor = themeColor;
        mModels = models;
        fillInfo();
        invalidate();
    }
